...
- `OPENFACTURA_AUTO_ISSUE`, `OPENFACTURA_API_KEY`, `OPENFACTURA_ENDPOINT`, `OPENFACTURA_DTE_TYPE`, `OPENFACTURA_COMPANY_RUT`, `OPENFACTURA_COMPANY_NAME`. Mantener `OPENFACTURA_AUTO_ISSUE=false` mientras Haulmer no este operativo para encolar DTE sin afectar las entradas.
