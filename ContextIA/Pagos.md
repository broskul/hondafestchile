...
5. Al aprobarse el pago, `completeOrderPayment` marca la orden como pagada, crea tickets con codigo QR y solicita boleta.
6. `POST /api/webhooks/mercadopago` consulta el pago y completa la orden si viene aprobado.
